...
// Commandline: /Applications/l3p voyager1a.ldr voyager1a_a.pov -sw1.1 -o -b1,1,1 -ld -cg0,0 -q2 -ca30
...
camera {
	...
	location vaxis_rotate(<160.676,-240.805,-2333.8> + PCT/100.0*<0,0,-2459.62>,
	                      <0,-6.04972e+06,0>,STEREO)
	sky      -y
	right    -4/3*x
	look_at  <160.676,-240.805,125.821> // calculated
	angle    30
...
// Lights:
light_source {
	<178.136,-1989.29,-1613.39>  // Latitude,Longitude,Radius: 45,0,2459.62
	color rgb <1,1,1>
}
light_source {
	<2022.85,-1479.89,1190.87>  // Latitude,Longitude,Radius: 30,120,2459.62
	color rgb <1,1,1>
}
light_source {
	<-886.909,-2380.17,740.726>  // Latitude,Longitude,Radius: 60,-120,2459.62
	color rgb <1,1,1>
}

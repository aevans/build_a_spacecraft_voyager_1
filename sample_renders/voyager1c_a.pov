...
// Commandline: /Applications/l3p voyager1c.ldr voyager1c_a.pov -sw1.1 -o -b1,1,1 -ld -cg0,0 -q2 -ca30
...
camera {
	...
	location vaxis_rotate(<-39.0978,-105.456,-2087.14> + PCT/100.0*<0,0,-2085.97>,
	                      <0,-4.35128e+06,0>,STEREO)
	sky      -y
	right    -4/3*x
	look_at  <-39.0978,-105.456,-1.16724> // calculated
	angle    30
...
// Lights:
light_source {
	<-22.4466,-1563.61,-1476.17>  // Latitude,Longitude,Radius: 45,0,2085.97
	color rgb <1,1,1>
}
light_source {
	<1542.03,-1131.59,902.086>  // Latitude,Longitude,Radius: 30,120,2085.97
	color rgb <1,1,1>
}
light_source {
	<-925.7,-1895.11,520.326>  // Latitude,Longitude,Radius: 60,-120,2085.97
	color rgb <1,1,1>
}

...
// Commandline: /Applications/l3p voyager1b.ldr voyager1b_a.pov -sw1.1 -o -b1,1,1 -ld -cg0,0 -q2 -ca30
...
camera {
	...
	location vaxis_rotate(<243.671,-48.9126,-1427.3> + PCT/100.0*<0,0,-1525.15>,
	                      <0,-2.32608e+06,0>,STEREO)
	sky      -y
	right    -4/3*x
	look_at  <243.671,-48.9126,97.8524> // calculated
	angle    30
...
// Lights:
light_source {
	<241.966,-1144.34,-980.591>  // Latitude,Longitude,Radius: 45,0,1525.15
	color rgb <1,1,1>
}
light_source {
	<1385.83,-828.471,758.262>  // Latitude,Longitude,Radius: 30,120,1525.15
	color rgb <1,1,1>
}
light_source {
	<-418.443,-1386.72,479.14>  // Latitude,Longitude,Radius: 60,-120,1525.15
	color rgb <1,1,1>
}

...
// Date: Sat Apr 20 22:16:19 2013
// Input file: voyager1_parts_view.ldr
// ModelDir: 
// LDRAWDIR: /Volumes/MACOSX/Users/aevans/Documents/LDRAW
// Commandline: /Applications/l3p voyager1_parts_view.ldr voyager1_parts_view_on_black.pov -sw1.1 -o -b0.1,0.1,0.1 -ld -cg0,0 -q3 -ca30 -sw0.1
...
#declare voyager1__parts__view_dot_ldr = union {
// untitled model
// Name:
// Author: Anthony Evans
	object {
		...
		matrix <-0,0.866025,0.499999,0.866025,0.25,-0.433012,-0.499999,0.433013,-0.75,305.92,-26.0449,-477.249>
		#if (version >= 3.1) material #else texture #end { Color15 }
	}
	object {
		_87994_dot_dat
		matrix <1-SW/8,0,0,0,1-SW/60,0,0,0,1-SW/8,0,SW/2,0>
		matrix <-0,0.866025,0.499999,0.866025,0.25,-0.433012,-0.499999,0.433013,-0.75,243.566,-44.0448,-446.072>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_87994_dot_dat
		matrix <1-SW/8,0,0,0,1-SW/60,0,0,0,1-SW/8,0,SW/2,0>
		matrix <-0,0.866025,0.499999,0.866025,0.25,-0.433012,-0.499999,0.433013,-0.75,382.13,-4.04485,-515.354>
		#if (version >= 3.1) material #else texture #end { Color308 }
	}
	object {
		_4740_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/40,0,SW/6,0>
		matrix <-0,0.866025,0.499999,0.866025,0.25,-0.433012,-0.499999,0.433013,-0.75,500.776,30.2052,-574.677>
		#if (version >= 3.1) material #else texture #end { Color15 }
	}
	object {
		_3741_dot_dat
		matrix <1-SW/50.4982,0,0,0,1-SW/51,0,0,0,1-SW/41.232,SW/58.312,SW/-5.36842,SW/9.40517>
		matrix <-0,0.866025,0.499999,0.866025,0.25,-0.433012,-0.499999,0.433013,-0.75,473.063,22.205,-560.82>
		#if (version >= 3.1) material #else texture #end { Color15 }
	}
	object {
		_3941_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/28,0,0,0,1-SW/40,0,SW/2.8,0>
		matrix <-0,0.866025,0.499999,0.866025,0.25,-0.433012,-0.499999,0.433013,-0.75,208.925,-54.0449,-428.752>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_4032a_dot_dat
		matrix <1-SW/47.7791,0,0,0,1-SW/12,0,0,0,1-SW/47.7791,0,SW/6,0>
		matrix <-0,0.866025,0.499999,0.866025,0.25,-0.433012,-0.499999,0.433013,-0.75,188.141,-60.0448,-418.359>
		#if (version >= 3.1) material #else texture #end { Color0 }
	}
	object {
		_64644_dot_dat
		matrix <1-SW/16,0,0,0,1-SW/44,0,0,0,1-SW/16,0,SW/2.44444,0>
		matrix <-0,0.866025,0.499999,-0.866025,-0.25,0.433012,0.499999,-0.433013,0.75,368.274,-8.04485,-508.426>
		#if (version >= 3.1) material #else texture #end { Color7 }
	}
	object {
		_44728_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/44,0,0,0,1-SW/28,0,SW/2.44444,SW/-7>
		matrix <-0.499999,0.433013,-0.75,0.866025,0.25,-0.433012,0,-0.866025,-0.499999,146.572,-63.3846,-392.575>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_44728_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/44,0,0,0,1-SW/28,0,SW/2.44444,SW/-7>
		matrix <0.499999,-0.433012,0.749998,0.866025,0.25,-0.433012,-0,0.866025,0.499999,146.572,-80.705,-402.575>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_44728_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/44,0,0,0,1-SW/28,0,SW/2.44444,SW/-7>
		matrix <0,-0.866025,-0.499999,0.866025,0.25,-0.433012,0.499999,-0.433012,0.749998,93.0742,-81.7147,-380.826>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		
dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <0.75,0.649519,-0.125,0.433013,-0.624999,-0.649518,-0.499999,0.433013,-0.75,27.5542,139.378,-196.313>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_30374_dot_dat
		matrix <1-SW/8,0,0,0,1-SW/80,0,0,0,1-SW/8,0,SW/2,0>
		matrix <0.75,0.649519,-0.125,0.433013,-0.624999,-0.649518,-0.499999,0.433013,-0.75,-38.6967,235.069,-96.8979>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_3062b_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <0.75,0.649519,-0.125,0.433013,-0.624999,-0.649518,-0.499999,0.433013,-0.75,6.33664,168.859,-165.147>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_3794a_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <-0.499999,0.433012,-0.749998,0.433011,-0.624999,-0.649517,-0.749999,-0.649517,0.125,68.1211,83.927,-255.224>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_3794a_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <-0.499999,0.433013,-0.75,-0,0.866025,0.499999,0.866025,0.25,-0.433012,109.751,-311.436,-511.389>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_3794a_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <-0.499999,0.433013,-0.75,-0,0.866025,0.499999,0.866025,0.25,-0.433012,92.4309,-316.436,-502.728>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_3794a_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <0.866025,0.25,-0.433012,-0,0.866025,0.499999,0.499999,-0.433013,0.75,101.091,-334.721,-519.058>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_6541_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/28,0,0,0,1-SW/20,0,SW/2.8,0>
		matrix <0.866025,0.25,-0.433012,-0,0.866025,0.499999,0.499999,-0.433013,0.75,101.091,-445.572,-583.058>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_3024_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/12,0,0,0,1-SW/20,0,SW/6,0>
		matrix <0.866025,0.25,-0.433012,-0,0.866025,0.499999,0.499999,-0.433013,0.75,101.091,-355.506,-531.058>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_30039_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <0.866025,0.25,-0.433012,-0,0.866025,0.499999,0.499999,-0.433013,0.75,101.091,-466.357,-595.058>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_43898_dot_dat
		matrix <1-SW/60,0,0,0,1-SW/20,0,0,0,1-SW/60,0,SW/3.33333,0>
		matrix <0.866025,0.25,-0.433012,-0.499999,0.433013,-0.75,-0,0.866025,0.499999,88.0912,-377.156,-569.558>
		#if (version >= 3.1) material #else texture #end { Color7 }
	}
	object {
		_43898_dot_dat
		matrix <1-SW/60,0,0,0,1-SW/20,0,0,0,1-SW/60,0,SW/3.33333,0>
		matrix <0.866025,0.25,-0.433012,0.499999,-0.433012,0.749998,0,-0.866025,-0.499999,114.091,-399.673,-530.558>
		#if (version >= 3.1) material #else texture #end { Color7 }
	}
	object {
		_4276a_dot_dat
		matrix <1-SW/54,0,0,0,1-SW/12,0,0,0,1-SW/20,SW/7.71429,SW/6,0>
		matrix <0,-0.866025,-0.499999,0.499999,-0.433013,0.75,-0.866024,-0.249999,0.433012,-89.2745,-107.796,-335.652>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_4275a_dot_dat
		matrix <1-SW/54,0,0,0,1-SW/12,0,0,0,1-SW/20,SW/7.71429,SW/6,0>
		matrix <-0.433013,0.808012,-0.399518,0.249999,0.533493,0.808012,0.866024,0.249999,-0.433012,-75.1274,-162.63,-339.016>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_4276a_dot_dat
		matrix <1-SW/54,0,0,0,1-SW/12,0,0,0,1-SW/20,SW/7.71429,SW/6,0>
		matrix <0,-0.866025,-0.499999,0.499999,-0.433013,0.75,-0.866024,-0.249999,0.433012,-303.8,-142.012,-276.389>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_4275a_dot_dat
		matrix <1-SW/54,0,0,0,1-SW/12,0,0,0,1-SW/20,SW/7.71429,SW/6,0>
		matrix <-0.433013,0.808012,-0.399518,0.249999,0.533493,0.808012,0.866024,0.249999,-0.433012,-289.653,-224.558,-295.753>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_4275a_dot_dat
		matrix <1-SW/54,0,0,0,1-SW/12,0,0,0,1-SW/20,SW/7.71429,SW/6,0>
		matrix <-0,0.866025,0.499999,0.499999,-0.433013,0.75,0.866024,0.249999,-0.433012,-315.8,-131.619,-294.389>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_4275a_dot_dat
		matrix <1-SW/54,0,0,0,1-SW/12,0,0,0,1-SW/20,SW/7.71429,SW/6,0>
		matrix <-0,0.866025,0.499999,0.499999,-0.433013,0.75,0.866024,0.249999,-0.433012,-93.2745,-104.332,-341.652>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_4276a_dot_dat
		matrix <1-SW/54,0,0,0,1-SW/12,0,0,0,1-SW/20,SW/7.71429,SW/6,0>
		matrix

		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_4150ps3_dot_dat
		matrix <1-SW/53.0557,0,0,0,1-SW/8,0,0,0,1-SW/47.7803,0,SW/2,0>
		matrix <0.866024,0.249999,-0.433012,0.499999,-0.433013,0.75,0,-0.866025,-0.499999,-279.303,-107.227,-336.638>
		#if (version >= 3.1) material #else texture #end { Color366 }
	}
	object {
		_3069bp53_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <-0.433012,-0.058013,-0.899518,0.25,-0.966506,-0.058013,-0.866024,-0.249999,0.433012,-295.769,-58.6991,-212.226>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_3069bp05_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <-0.433012,-0.058013,-0.899518,-0.25,0.966506,0.058013,0.866024,0.249999,-0.433012,-212.047,-310.534,-190.178>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_3069bp05_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <-0.433012,-0.058013,-0.899518,-0.25,0.966506,0.058013,0.866024,0.249999,-0.433012,-46.5208,-199.242,-302.941>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_3069b_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/20,0,SW/2,0>
		matrix <-0.433012,-0.058012,-0.899518,0.249999,-0.966506,-0.058013,-0.866024,-0.249999,0.433012,-81.2435,-66.0529,-295.489>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_3068b_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/40,0,SW/2,0>
		matrix <0,-0.866025,-0.499999,0.499999,-0.433013,0.75,-0.866024,-0.249999,0.433012,-2.67197,-82.7961,-378.953>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_3068bp07_dot_dat
		matrix <1-SW/40,0,0,0,1-SW/8,0,0,0,1-SW/40,0,SW/2,0>
		matrix <-0,0.866025,0.499999,-0.499999,0.433012,-0.749998,-0.866024,-0.249999,0.433012,-177.088,-241.785,-103.663>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_3068bps0_dot_dat
		matrix <1-SW/40.1,0,0,0,1-SW/8,0,0,0,1-SW/40,SW/-801.997,SW/2,0>
		matrix <0.433013,-0.808012,0.399518,0.249999,0.533493,0.808012,-0.866024,-0.249999,0.433012,-284.72,-244.797,-320.665>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_61409_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/15.48,0,0,0,1-SW/40,0,SW/-2,0>
		matrix <-0.866024,-0.249999,0.433012,-0.249999,-0.533493,-0.808012,0.433013,-0.808012,0.399518,-46.2745,-102.6,-246.652>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_61409_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/15.48,0,0,0,1-SW/40,0,SW/-2,0>
		matrix <-0.866024,-0.249999,0.433012,-0.249999,-0.533493,-0.808012,0.433013,-0.808012,0.399518,-211.8,-137.681,-89.889>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_4085c_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/12,0,0,0,1-SW/34,0,SW/6,SW/-4.85714>
		matrix <0.433012,0.058013,0.899518,0.25,-0.966506,-0.058013,0.866024,0.249999,-0.433012,-361.557,-97.3275,-273.728>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_4085c_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/12,0,0,0,1-SW/34,0,SW/6,SW/-4.85714>
		matrix <0,-0.866025,-0.499999,-0.499999,0.433012,-0.749998,0.866024,0.249999,-0.433012,-197.257,-260.903,-50.9587>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_57274_dot_dat
		matrix <1-SW/8,0,0,0,1-SW/640,0,0,0,1-SW/8,0,SW/2,0>
		matrix <-0,0.866025,0.499999,0.499999,-0.433012,0.749998,0.866024,0.249999,-0.433012,-218.608,-262.443,-48.363>
		#if (version >= 3.1) material #else texture #end { Color7 }
	}
	object {
		_57274_dot_dat
		matrix <1-SW/8,0,0,0,1-SW/640,0,0,0,1-SW/8,0,SW/2,0>
		matrix <-0.433012,-0.058013,-0.899518,-0.25,0.966506,0.058013,0.866024,0.249999,-0.433012,-376.877,-110.122,-265.567>
		#if (version >= 3.1) material #else texture #end { Color7 }
	}
	object {
		_4081a_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/16,0,0,0,1-SW/38,0,SW/8,SW/-4.22222>
		matrix <-0,0.866025,0.499999,0.499999,-0.433012,0.749998,0.866024,0.249999,-0.433012,-411.441,-97.4519,-373.568>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_87618_dot_dat
		matrix <1-SW/11,0,0,0,1-SW/104,0,0,0,1-SW/40,0,SW/-2.23656,SW/-4>
		matrix <0.707106,-0.353553,0.612371,0.707106,0.353553,-0.612372,-0,0.866025,0.499999,-428.807,-89.4822,-355.373>
		#if (version >= 3.1) material #else texture #end { Color7 }
	}
	object {
		_4081a_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/16,0,0,0,1-SW/38,0,SW/8,SW/-4.22222>
		matrix <-0.433012,-0.058013,-0.899518,-0.25,0.966506,0.058013,0.866024,0.249999,-0.433012,-273.971,-296.208,-214.009>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_87618_dot_dat
		matrix <1-SW/11,0,0,0,1-SW/104,0,0,0,1-SW/40,0,SW/-2.23656,SW/-4>
		matrix <-0.017337,0.998276,-0.056036,0.901219,-0.008669,-0.433273,-0.433012,-0.058013,-0.899518,-298.72,-300.203,-219.625>
		#if (version >= 3.1) material #else texture #end { Color7 }
	}
	object {
		_4081a_dot_dat
		matrix <1-SW/20,0,0,0,1-SW/16,0,0,0,1-SW/38,0,SW/8,SW/-4.22222>
		matrix <0.433013,-0.808012,0.399518,-0.249999,-0.533493,-0.808012,0.866024,0.249999,-0.433012,-216.117,-223.335,-55.5998>
		#if (version >= 3.1) material #else texture #end { Color8 }
	}
	object {
		_87618_dot_dat
		matrix <1-SW/11,0,0,0,1-SW/104,0,0,0,1-SW/40,0,SW/-2.23656,SW/-4>
		matrix <-0.017337,-0.45061,-0.892551,0.90122,0.37956,-0.209129,0.433013,-0.808012,0.399518,-227.01,-242.33,-42.1632>
		#if (version >= 3.1) material #else texture #end { Color7 }
	}
	object {
		_2335_dot_dat
		matrix <1-SW/12,0,0,0,1-SW/40,0,0,0,1-SW/54,0,SW/2,SW/2.34783>
		matrix <-0.499999,-0.362373,-0.786565,0.707106,0.353553,-0.612372,0.5,-0.862371,0.079459,-472.647,-111.402,-317.405>
		#if (version >= 3.1) material #else texture #end { Color7 }
	}
}


object { voyager1__parts__view_dot_ldr #if (version >= 3.1) material #else texture #end { Color7 } }
...
camera {
	...
	location vaxis_rotate(<33.7468,21.8287,-3046.46> + PCT/100.0*<0,0,-2959.37>,
	                      <0,-8.75786e+06,0>,STEREO)
	sky      -y
	right    -4/3*x
	look_at  <33.7468,21.8287,-87.0906> // calculated
	angle    30
...
// Lights:
light_source {
	<-12.1845,-2063.89,-2179.68>  // Latitude,Longitude,Radius: 45,0,2959.37
	color rgb <1,1,1>
}
light_source {
	<2207.34,-1450.98,1194.35>  // Latitude,Longitude,Radius: 30,120,2959.37
	color rgb <1,1,1>
}
light_source {
	<-1293.63,-2534.19,652.752>  // Latitude,Longitude,Radius: 60,-120,2959.37
	color rgb <1,1,1>
}
...
// stud.dat: 107
// BoundingBox: <-542.073,-544.035,-609.549> <517.704,601.435,435.368>
// Center: <-12.1845,28.7003,-87.0905>
// Size: <1059.78,1145.47,1044.92>
